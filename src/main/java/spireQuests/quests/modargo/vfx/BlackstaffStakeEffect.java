...
public class BlackstaffStakeEffect extends AbstractGameEffect {
    ...
    public BlackstaffStakeEffect(float x, float y) {
        if (img == null) {
        ...
        this.color = new Color(MathUtils.random(0.8F, 1.0F), MathUtils.random(0.0F, 0.2F), MathUtils.random(0.0F, 0.2F), 0.0F);
    }
