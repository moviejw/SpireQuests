...
public class BlackstaffParticleEffect extends AbstractGameEffect {
    ...
    public BlackstaffParticleEffect(float sX, float sY, float tX, float tY, boolean facingLeft) {
        ...
        this.color = new Color(0.8F, 0.1F, 0.1F, 0.6F);
        this.duration = 0.7F;
